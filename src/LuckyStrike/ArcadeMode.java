...
public class ArcadeMode {
    ...
    public String getSkillchoice(String one, String two, String three, String four){
        try {
            ...
            SkillChoice choose = (SkillChoice) ld.getController();
            ...
            //SkillChoice.first.setText(attacker.getOffend());
            //SkillChoice.two.setText(attacker.getNoffend());
            //SkillChoice.three.setText("Check my Status");
            //SkillChoice.four.setText("Check Enemy Status");
